...
public class AsyncMessageNotification extends EnrichedServerNotification implements SynchronousServerEvent {
  ...
  public AsyncMessageNotification(EnrichedNotificationInfo notificationInfo, FlowConstruct flowConstruct,
                                  int action, MessagingException exception) {
    this(notificationInfo, flowConstruct, action);
